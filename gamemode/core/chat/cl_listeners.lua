...
local function drawChatRecipients()
    ...
    local fontHeight = draw.GetFontHeight("ag.font.ChatRecipients")
    ...
    if recipientsCount == 0 then
        draw.WordBox(
            ...
            "ag.font.ChatRecipients", backgroundColor, textColorRed, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER
        )
        return
    elseif recipientsCount == player.GetCount() - 1 then
        draw.WordBox(
            4, x, y, ag.lang.GetPhrase("hear_everyone") .. chatTypeStr,
            "ag.font.ChatRecipients", backgroundColor, textColorGreen, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER
        )
        return
    end
    ...
    for i = 1, recipientsCount do
        ...
        draw.WordBox(
            ...
            "ag.font.ChatRecipients", backgroundColor, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER
        )
    end
end
